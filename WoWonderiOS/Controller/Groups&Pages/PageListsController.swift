...
class PageListsController: UIViewController,EditPageDelegete,DeletePageDelegate,PageLikeDelegate{
    ...
    var pageLabeltxt = "Explore Pages"
    var btnHidden = false
    var offset = "0"
    var isOwner =  false
    var editingIndex = 0
    ...
    override func viewDidLoad() {
       ...
       self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Create", style: .done, target: self, action: #selector(self.CreatePage(sender:)))
        }
