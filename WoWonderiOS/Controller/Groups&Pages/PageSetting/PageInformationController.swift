...
//        self.companyField.text = self.pageData.company
//        self.phoneField.text = self.pageData.phone
//        self.locationField.text = self.pageData.address
//        self.websiteField.text = self.pageData.phone
//        self.aboutField.text = self.pageData.about
...
//                        self.pageData.company = self.companyField.text!
//                        self.pageData.phone = self.phoneField.text!
//                        self.pageData.address = self.locationField.text!
//                        self.pageData.website = self.websiteField.text!
//                        self.pageData.about = self.aboutField.text!
