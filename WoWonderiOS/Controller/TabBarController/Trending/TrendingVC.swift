...
class TrendingVC: UIViewController {
    ...
    func showStoriesLog(){
             let alert = UIAlertController(title: "source", message: "Add new Story", preferredStyle: .actionSheet)
             ...
             let videos = UIAlertAction(title: "videos", style: .default) { (UIAlertAction) in
                 self.isVideo = true
                 let imagePickerController = UIImagePickerController()
...
extension TrendingVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case 0: return 1
        case 1: return 1
        case 2: return self.lastActivitiesArray.count ?? 0
        default: return 0
        }
    }
