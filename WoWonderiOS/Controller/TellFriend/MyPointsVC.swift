...
class MyPointsVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "My Points"
    ...
    private func setupUI(){
        ...
        self.dataSet = [
            dataSetMyPoints(BGColor: .green, iconImage: UIImage.fontAwesomeIcon(name: .comment, style: .regular, textColor: UIColor.white, size: CGSize(width: 40, height: 40)) , title: "Earn 10 by commenting any post"),
            dataSetMyPoints(BGColor: .blue, iconImage: UIImage.fontAwesomeIcon(name: .newspaper, style: .regular, textColor: UIColor.white, size: CGSize(width: 40, height: 40)) , title: "Earn 20 by creating new post"),
            dataSetMyPoints(BGColor: .orange, iconImage: UIImage.fontAwesomeIcon(name: .smile, style: .regular, textColor: UIColor.white, size: CGSize(width: 40, height: 40)) , title: "Earn 5 by reacting on any post"),
            dataSetMyPoints(BGColor: .gray, iconImage: UIImage.fontAwesomeIcon(name: .grinBeam, style: .regular, textColor: UIColor.white, size: CGSize(width: 40, height: 40)) , title: "Earn 15 by creating a new blog")
        ]
