...
class TellFriendVC: UIViewController {
    ...
    private func setupUI(){
        ...
        self.navigationItem.title = "Tell a Friend"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                ...
                cell.titleLabel.text = "My Affiliates"
                
                return cell
            case 1:
                let cell = tableView.dequeueReusableCell(withIdentifier: "HelpSupportTableItem") as! HelpSupportTableItem
                cell.titleLabel.text = "My Balance"
                return cell
                
            case 2:
                let cell = tableView.dequeueReusableCell(withIdentifier: "HelpSupportTableItem") as! HelpSupportTableItem
                cell.titleLabel.text = "My Points"
                return cell
