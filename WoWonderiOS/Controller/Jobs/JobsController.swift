...
class JobsController: UIViewController,JobDataDelegate,EditJobDataDelegate,DeleteJobDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.navigationBar.topItem?.backBarButtonItem = UIBarButtonItem(title: "", style: .plain, target: self, action: nil)
          ...
          self.navigationItem.title = "Offer a Job"
          let textAttributes = [NSAttributedString.Key.foregroundColor:UIColor.white]
          navigationController?.navigationBar.titleTextAttributes = textAttributes
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Create", style: .done, target: self, action: #selector(self.Create(_:)))
