...
class LikeReactionsController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.likeReaction.loadGif(name: "like")
        self.loveReaction.loadGif(name: "love")
        self.hahaReaction.loadGif(name: "haha")
        self.wowReaction.loadGif(name: "wow")
        self.sadReaction.loadGif(name: "sad")
        self.angryReaction.loadGif(name: "angry")
    }
