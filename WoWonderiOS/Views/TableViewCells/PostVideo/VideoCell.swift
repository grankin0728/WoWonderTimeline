...
class VideoCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        //        self.seekSlider.setThumbImage(UIImage(named: "circular-shape-silhouettet") , for: .normal)
        //        self.sliderView.isHidden = true
        //        Timer.scheduledTimer(timeInterval: 0.0001, target: self, selector: #selector(self.updateSlider), userInfo: nil, repeats: true)
