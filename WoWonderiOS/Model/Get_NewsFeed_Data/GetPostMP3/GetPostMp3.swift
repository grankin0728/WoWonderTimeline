...
//    var players : AVPlayer!
    ...
    @IBAction func NormalTapped(gesture: UIGestureRecognizer){
        ...
        case .online(.wwan), .online(.wiFi):
            let cell = self.tableView.cellForRow(at: IndexPath(row: gesture.view!.tag, section: 5)) as! MusicCell
    ...
    func addReaction(reation: String) {
        let cell = self.tableView.cellForRow(at: IndexPath(row: self.selectedIndex, section: 5)) as! MusicCell
    ...
    @IBAction func PlayBtn (sender:UIButton){
        let cell = self.tableView.cellForRow(at: IndexPath(row: sender.tag, section: 5)) as! MusicCell
    ...
    func stopSound (){
     ...
     @IBAction func updateSlider(){
         print("update")
        let cell = self.tableView.cellForRow(at: IndexPath(row: self.selectIndex ?? 0 , section: 5)) as! MusicCell
