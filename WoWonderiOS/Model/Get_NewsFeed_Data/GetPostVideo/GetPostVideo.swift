...
//            cell.videoView.configure(url: postfile)
//            //            let duration : CMTime =  (cell.videoView.player?.currentItem!.asset.duration)!
//            //            let seconds : Float64 = CMTimeGetSeconds(duration)
//            //            cell.totalTimer.text = self.stringFromTimeInterval(interval: seconds)
//            //            cell.seekSlider.maximumValue = Float(seconds)
//            cell.seekSlider.minimumValue = 0.0
//
//            cell.videoPlayButton.tag = indexpath.row
//            cell.videoPlayButton.addTarget(self, action: #selector(self.playVideo(_:)), for: .touchUpInside)
//
//
//            cell.videoView.isLoop = false
        }
    ...
    @IBAction func NormalTapped(gesture: UIGestureRecognizer){
        ...
        case .online(.wwan), .online(.wiFi):
            let cell = self.tableView.cellForRow(at: IndexPath(row: gesture.view!.tag, section: 5)) as! VideoCell
    ...
    func addReaction(reation: String) {
        let cell = self.tableView.cellForRow(at: IndexPath(row: self.selectedIndex, section: 5)) as! VideoCell
    ...
    @objc func playVideo (_ sender : UIButton){
        ...
        let cell = tableView.cellForRow(at: IndexPath(row: indexPath.row, section: 5)) as! VideoCell
        cell.videoView.play()
