...
class getPhotoAlbum :AddReactionDelegate,SharePostDelegate {
    ...
    @IBAction func NormalTapped(gesture: UIGestureRecognizer){
        ...
        case .online(.wwan), .online(.wiFi):
             if let images_count = self.postArray[gesture.view!.tag]["photo_album"] as? [[String:Any]]{
                ...
                let cell = self.tableView.cellForRow(at: IndexPath(row: gesture.view!.tag, section: 5)) as! PhotoAlbumCell
                ...
                let cell = self.tableView.cellForRow(at: IndexPath(row: gesture.view!.tag, section: 5)) as! PhotoAlbum2
                ...
                let cell = self.tableView.cellForRow(at: IndexPath(row: gesture.view!.tag, section: 5)) as! PhotoAlbum3
    ...
    func addReaction(reation: String) {
         if let images_count = self.postArray[self.selectedIndex]["photo_album"] as? [[String:Any]]{
            if  images_count.count == 1{
            let cell = self.tableView.cellForRow(at: IndexPath(row: self.selectedIndex, section: 5)) as! PhotoAlbumCell
            ...
            let cell = self.tableView.cellForRow(at: IndexPath(row: self.selectedIndex, section: 5)) as! PhotoAlbum2
            self.reactions(index: self.selectedIndex, reaction: reation)
            var localPostArray = self.postArray[self.selectedIndex]["reaction"] as! [String:Any]
            var totalCount = 0
            if let reactions = self.postArray[self.selectedIndex]["reaction"] as? [String:Any]{
            ...
            let cell = self.tableView.cellForRow(at: IndexPath(row: self.selectedIndex, section: 5)) as! PhotoAlbum3
            self.reactions(index: self.selectedIndex, reaction: reation)
            var localPostArray = self.postArray[self.selectedIndex]["reaction"] as! [String:Any]
            var totalCount = 0
            if let reactions = self.postArray[self.selectedIndex]["reaction"] as? [String:Any]{
