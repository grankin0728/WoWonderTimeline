...
class GetPostReactionManager {
    ...
    func getReactions(postID: String,completionBlock : @escaping (_ Success:GetPost_ReactionsModel.GetPostReactionSuccessModel?, _ AuthError : GetPost_ReactionsModel.GEtPostReactionErrorModel? , Error?)->()) {
        let params = [APIClient.Params.serverKey : APIClient.SERVER_KEY.Server_Key, APIClient.Params.id : postID,APIClient.Params.type : "post",APIClient.Params.reactions : "1,2,3,4,5,6"]
